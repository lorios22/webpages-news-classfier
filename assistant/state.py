...
class ClassifierState:
    ...
    relevance_analyzer_state: Dict = field(
        default_factory=dict
    )  # Relevance analysis results
    structure_analyzer_state: Dict = field(
        default_factory=dict
    )  # Structure analysis results
    historical_reflection_state: Dict = field(
        default_factory=dict
    ...
    context_evaluator_state: Dict = field(
        default_factory=dict
    )  # Context evaluator results
    score_consolidator_state: Dict = field(
        default_factory=dict
    )  # Score consolidator results
    ...
    reflective_validator_state: Dict = field(
        default_factory=dict
    )  # Reflective validator results
