...
def check_results():
    ...
    dirs_to_check = ['enhanced_results', 'crypto_macro_results', 'comprehensive_results']
    ...
    for dir_name in dirs_to_check:
        if os.path.exists(dir_name):
            ...
            results[dir_name] = {
                ...
                'files': files,
                'total_size': sum(os.path.getsize(os.path.join(dir_name, f)) for f in files if os.path.isfile(os.path.join(dir_name, f)))
            }
        else:
...
def main():
    ...
    try:
        ...
        python_processes = [line for line in lines if 'python' in line.lower() and ('enhanced' in line or 'comprehensive' in line)]
