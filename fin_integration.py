...
class FINIntegration:
    ...
    def __init__(self):
        ...
        self.positive_keywords = [
            'gain', 'rise', 'surge', 'jump', 'rally', 'bull', 'bullish', 'optimistic',
            'growth', 'increase', 'profit', 'success', 'breakthrough', 'positive'
        ]
        
        self.negative_keywords = [
            'fall', 'drop', 'crash', 'decline', 'bear', 'bearish', 'pessimistic',
            'loss', 'decrease', 'plunge', 'collapse', 'negative', 'concern', 'worry'
        ]
    ...
    def count_crypto_mentions(self, content: str) -> int:
        ...
        crypto_keywords = ['bitcoin', 'ethereum', 'crypto', 'blockchain', 'btc', 'eth', 'defi', 'nft']
        content_lower = content.lower()
